...
module.exports = (req) => {
	...
	if (path === '*' && req.method !== 'OPTIONS') return; // asterisk-form: https://tools.ietf.org/html/rfc7230#section-5.3.4
	if (host) {
...
// Domain Names: https://tools.ietf.org/html/rfc1123#section-2
