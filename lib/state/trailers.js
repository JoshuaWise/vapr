...
class Trailers extends Headers {
	set(name, value) {
		...
		else if (typeof value !== 'string') throw new TypeError('Expected response trailer value to be a string or promise');
		if (typeof name !== 'string') throw new TypeError('Expected response trailer name to be a string');
