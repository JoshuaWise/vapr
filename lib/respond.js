...
/*
	...
	transfer-encoding: respects a given value unless invalid; may modify
	content-length: completely overwrites
	trailer: completely overwrites
	date: uses the given value, but sets a default value if not given
	connection: uses the given value, but may set a default value if not given
 */
