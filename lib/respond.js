...
/*
	...
	trailer: uses the given value and logs a warning, or applies its own value
	date: uses the given value and logs a warning, or applies its own value
	connection: uses the given value and logs a warning if not "close", or applies its own value
 */
