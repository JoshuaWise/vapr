...
/*
	...
	NOTE: adding trailers could throw if the trailers are invalid
 */
...
/*
	Headers owned:
	- transfer-encoding (default value is based on whether res.write is ever used)
	- content-length
	- trailer
	- date (default value is automatic)
	- connection (default value is automatic)
 */
