...
class Application {
	constructor(options) {
		...
		this[settings] = { options, router: undefined, server: undefined };
	...
	listen(port, options) {
		return new Promise((resolve, reject) => {
			if (this[settings].server) throw new TypeError('Attempt to listen twice on the same application');
			const server = (options == null ? http : https).createServer(options, this);
