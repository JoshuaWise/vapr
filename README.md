...
Vapr is mostly concerned with being high-level—it doesn't try to be the fastest—yet it still performs well. The result of a simple "hello world" benchmark is shown below.
