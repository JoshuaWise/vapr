...
With Vapr, the `req` object is *deeply immutable*, so programmers can safely rely on the values within it, knowing with certainty that they were not modified by some other code. This might seem like a minor feature, but it gives you an idea of how seriously Vapr is about dependability.
