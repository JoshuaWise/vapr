...
As seen above, wildcards (`*`) can be used in any subdomain position and/or the port position. Wildcards are only used when a given request doesn't have an exact match.
