...
Vapr is mostly concerned with being high-level—it doesn't try to be the fastest—yet it still performs well. Below is the result of a simple "hello world" benchmark.
